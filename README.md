...
`config.h` agrupa los pines que se utilizan, variables globales y otras constantes de interñes.
`main.cpp` se encarga de inicializar los diferentes módulos y ejecutar la aplicación a alto nivel.
